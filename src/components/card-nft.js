...
export default function CardNFT({imagePath, title}) {
  return (
      ...
      <div className='w-full p-4'>
        ...
        <div className='flex justify-between items-end'>
          <div>
            ...
            <h3 className='flex items-center justify-center gap-1 font-semibold mt-1'><Image src={IconEtherum} alt='icon verify'></Image>0.0721 BTC</h3>
          </div>
          <h5 className='text-xs relative bottom-1'>$602,00</h5>
        </div>
      </div>
      <button className='w-full max-w-[248px] leading-[48px] mx-auto flex items-center justify-center px-20 bg-background-button-nft rounded-[122px] mb-4 hover:brightness-75 transition'>Buy Now</button>
      <div className='mt-4 space-x-2 flex flex-row ml-4'>
